...
> **最后审计**：2026-06-04（基于 CodeGraph 系统性分析 + Manager层文档完成）
...
|------|-------------|-------------|--------|------|
| **Domain 实体** | ~58 个 | ~46 个 | **~79%** ⬆️ | 🟢 显著改善 |
| **Application 服务** | ~75 个 | ~69 个 | **~92%** | 🟢 基本完整 |
| **Manager 类** | ~15 个 | ~13 个 | **~87%** ⬆️ | 🟢 核心完整 |
| **EventHandler** | ~15 个 | ~15 个 | **~100%** ✅ | 🟢 完整 |
| **Hangfire Jobs** | 12 个 | 12 个 | **100%** | 🟢 完整 |
| **框架/宿主** | 12 个 | 12 个 | **100%** | 🟢 完整 |
| **管理端 API** | 10+ 端点 | 14 篇 | **100%** | 🟢 完整 |
| **全项目覆盖** | - | - | **~91%+** ⬆️ | 🟢 接近完整 |
